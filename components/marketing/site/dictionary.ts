...
export const DICTIONARY = {
  de: {
    ...
    hero: {
      ...
      vat: "zzgl. MwSt.",
      total: "Gesamt",
      labelVoice: "Auftrag per Sprache",
      labelQuote: "Angebot mit Positionen",
      labelSigned: "Vom Kunden bestätigt",
      signedHeading: "Angebot bestätigt",
      signedBy: "Digital bestätigt von",
      signedCustomer: "Kunde",
    },
    trust: {
      label: "Gebaut für",
  ...
  en: {
    ...
    hero: {
      ...
      vat: "plus VAT",
      total: "Total",
      labelVoice: "Job details via voice",
      labelQuote: "Itemised quote",
      labelSigned: "Signed by customer",
      signedHeading: "Quote signed",
      signedBy: "Digitally confirmed by",
